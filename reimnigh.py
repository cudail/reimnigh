...
class Leagan():
	def __init__(self, *,
	             mír:str='', séimhiú:bool=False, urú:bool=False,
	...
	def réimnigh(self, fréamh, forainm=""):
		...
		print(f"  {m}{céad_litir}{s}{litreacha_eile}{d}{f}")
...
class Réimniú():
	def __init__(self):
		...
		self.aimsirí = [self.a_chaite, self.a_gchaite, self.a_láith, self.a_fháist]
